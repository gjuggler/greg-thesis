...
Second, the modular pipeline organization allowed each analysis to be
...
\bresp{Applicability of Simulations}

Beyond the direct comparison to the results from
...
\eresp{Applicability of Simulations}
