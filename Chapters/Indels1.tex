...
In addition, the protein structure and the evolutionary divergence of
...
\citeyearpar{Fletcher2010} performed a series of simulation
...
power of \sw evolutionary inference of positive selection. This
...
detecting \sw positive selection. Furthermore, I incorporate a diverse
sample of aligners and alignment filters into an experimental design
...
(Lindblad-Toh et al. \citeyear{LindbladToh2011}; log-normal parameters shown in Table
...
(SLR; \citealt{Massingham2005}) software packages.
...
PAML's \sw random sites models \citep{Massingham2005}. SLR
...
\citeyearpar{Massingham2005} I use a signed version of the
...
Since the performance measurements shown in Figure \ref{fig_5}
...
A tangential but interesting observation from these simulations was that
