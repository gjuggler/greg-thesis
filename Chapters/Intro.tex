...
\citet{Notredame2007} for reviews of contemporary issues and progress
...
a much lower rate \citep{Benner1993}. As with sequence mutations, the
...
Misalignment occurs when the sequence-level homology between
...
in phylogenetic tree inference \citep{TODO}, while studies have
...
inference \citep{TODO} and is simple to include in a large-scale
...
A more desirable approach to mitigating the impact of misalignment
