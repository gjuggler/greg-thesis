...
\todo{Write an introductory page or two. Keep it broad, cite some old
  stuff.}
...
\section{Biological background}
  ...
  \todo{Write a quick summary of the genome evolution of vertebrates
  ...
  \label{popgen_intro}
  \todo{Introduce the concept of adaptation (molecular
...
\section{Mathematical methods for genomic analysis}
  \label{math_intro}
  \todo{Introduce the importance of imperfect replication / copying as
  ...
  \label{codon_intro}
  \todo{Introduce the idea of modeling protein evolution as a markov
  ...
  \label{ml_intro}
  \todo{Briefly introduce the idea of nested models and likelihood
  ...
  \label{pos-sel_intro}
  \todo{Briefly run through the history of detecting purifying /
  ...
  \label{go_intro}
  \todo{Introduce the Gene Ontology and Pfam databases, which annotate
  ...
  \label{bh_intro}
  \todo{Note the issue of correcting for multiple testing in
