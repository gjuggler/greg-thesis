%************************************************
\chapter{Curating a set of genome-wide orthologous gene trees in mammals}
\label{ch_orthologs}
\acresetall
%************************************************
...
vertebrate genomes. Figure \ref{ortholog_euth_dups} shows the gene copy
...
\ref{ortholog_euth_dups}, confirming the trend observed in the set of
